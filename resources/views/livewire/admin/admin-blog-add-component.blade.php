		...
		<div class="row">
			<div class="col-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						...
						<form class="forms-sample" wire:submit.prevent="addBlog">
         ...
         id="short_description" rows="4" wire:model="short_description"></textarea>
							...
							<div class="form-group" wire:ignore>
								...
								<textarea class="bg-secondary text-dark form-control @error('description') is-invalid @enderror description" id="description"
