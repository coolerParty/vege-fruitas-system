						...
						<div class="header__top__right">
							...
							@if (Route::has('login'))
								@auth
									...
									<div class="header__top__right__auth">
										<a href="{{ route('logout') }}"
											onclick="event.preventDefault(); document.getElementById('logout-form').submit();" aria-expanded="false"><i
					...
					<div class="col-lg-6">
						<nav class="header__menu">
							<ul>
								...
								<li @if (url()->current() == route('shop.index')) class="active" @endif><a href="{{ route('shop.index') }}">Shop</a></li>
								<li><a href="#">Pages</a>
									<ul class="header__menu__dropdown">
										<li><a href="./shop-details.html">Shop Details</a></li>
										<li><a href="./shoping-cart.html">Shoping Cart</a></li>
